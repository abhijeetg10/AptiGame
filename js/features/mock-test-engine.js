...
function generateSequence() {
    const presets = {
        'atlas': ['games/motion.html', 'games/switch.html', 'games/rc.html', 'games/di.html'],
        'capgemini': ['games/sudoku.html', 'games/grid.html', 'games/rc.html', 'games/di.html'],
        'tcs': ['games/motion.html', 'games/sudoku.html', 'games/rc.html', 'games/di.html'],
        'cognizant': ['games/inductive.html', 'games/grid.html', 'games/rc.html', 'games/di.html']
    };

    currentState.sequence = presets[companyId] || ['games/rc.html', 'games/di.html', 'games/motion.html', 'games/sudoku.html'];
