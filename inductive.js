import { collection, addDoc, doc, setDoc, getDoc, onAuthStateChanged, db, auth, increment, serverTimestamp } from "./db-shim.js";
            ...
            try {
                ...
                try {
                    ...
                    await setDoc(weeklyRef, {
                        name: playerName,
                        score: increment(correctAnswers), // Using correctAnswers (Marks)
