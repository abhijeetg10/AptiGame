import { collection, addDoc, getDocs, query, orderBy, limit } from "https://www.gstatic.com/firebasejs/10.9.0/firebase-firestore.js";
...
async function endGame() {
    ...
    if (user) {
        try {
            await addDoc(collection(db, "leaderboards", "di", "scores"), {
